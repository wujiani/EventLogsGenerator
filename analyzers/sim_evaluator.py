...
# =============================================================================
    ...
    def log_emd_metric(self, log_data: list,
        ...
        for key, group in data.groupby(g_criteria[criteria]):
            ...
            if similarity[-1]['sim_score'] > 100:
            #     print(log_hist, sim_hist)
                print(key)
                print('w_df', w_df)
                print('log', log_hist)
                # print('sim', sim_hist)
...
# =============================================================================
    ...
    def scaling_data(self, data):
        ...
        if self.one_timestamp and 'duration' in data.columns:
    ...
    def reformat_events(self, data, features):
        ...
        if self.one_timestamp and 'duration' in data[0].keys():
